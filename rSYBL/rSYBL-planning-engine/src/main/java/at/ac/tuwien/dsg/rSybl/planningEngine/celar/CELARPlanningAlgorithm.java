...
package at.ac.tuwien.dsg.rSybl.planningEngine.celar;
/** 
...
public class CELARPlanningAlgorithm  implements Runnable{
	...
	public CELARPlanningAlgorithm(DependencyGraph cloudService,
	...
	public void findAndExecuteBestActions() {
		...
		HashMap<String, List<ActionEffect>> actionEffects = ActionEffectsCELAR.getActionEffects(dependencyGraph,monitoringAPI,contextRepresentation);
