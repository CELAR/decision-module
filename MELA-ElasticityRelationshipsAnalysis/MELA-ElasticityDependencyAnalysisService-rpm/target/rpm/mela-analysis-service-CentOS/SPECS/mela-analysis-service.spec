...
%description
Multilevel Metrics Evaluation module -Analysis
...
%attr(664,root,root) /opt/mela-analysis-service/MELA-SpaceAndPathwayAnalysisService-1.0-SNAPSHOT-exec-war.jar
